    ...
    return (
        ...
        {!isInLine && <Navigate to='/connecter' replace={true} />}
            <div className='img-para-container'>
             {myProfile && <img className='img-param' src={myProfile.photo } alt=''/>}
             {!myProfile && <img className='img-param' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtYqXjw6IR_opev4UADLjT8TPcLmWYQsx_YQ&usqp=CAU' alt=''/>}
             </div> 
