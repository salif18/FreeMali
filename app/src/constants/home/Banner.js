...
const Banner = () => {
    ...
    return (
        <section className='banner'>
            ...
            {!isInLine && <button className='btn-braner1' onClick={()=>navigate('/sign-presta')}>Devenir prestataire</button>}
            {!isInLine && <button className='btn-braner2'  onClick={()=>navigate('/sign-clients')}>Devenir clients</button>}
            </div>
          </div>
