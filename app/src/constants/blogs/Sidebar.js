      ...
      <div className="container-menu">
        <div className="mainsoeuvres">
          <div className="secteur">
            <AssuredWorkloadOutlinedIcon
              style={{ margin: 10, fontSize: 30, color: "#aaa" }}
            />
          ...
          <NavLink className="liens" to="/electricite">
            <TipsAndUpdatesIcon
              style={{ margin: 10, fontSize: 30, color: "orange" }}
            />
            Electriciens
          </NavLink>
          <NavLink className="liens" to="/mecanique">
            <GarageIcon style={{ margin: 10, fontSize: 30, color: "#aaa" }} />
            Mecaniciens
          </NavLink>
          <NavLink className="liens" to="/menuiserie">
            <ConstructionIcon
              style={{ margin: 10, fontSize: 30, color: "maroon" }}
            />
            Menuisiers
          </NavLink>
          <NavLink className="liens" to="/plomberie">
            <PlumbingRoundedIcon
              style={{ margin: 10, fontSize: 30, color: "blue" }}
            />
            Plombier
          </NavLink>
        </div>
        ...
        <div className="mainsoeuvres">
          ...
          <NavLink className="liens" to="/enseignants">
            <SentimentDissatisfiedIcon
              style={{ margin: 10, fontSize: 30, color: "green" }}
            />
            Enseignant(e)s
          </NavLink>
          <NavLink className="liens" to="/proffeseurs">
            <AutoStoriesIcon
              style={{ margin: 10, fontSize: 30, color: "red" }}
            />
            Proffesseur(e)s
          </NavLink>
        </div>
        ...
        <div className="mainsoeuvres">
          ...
          <NavLink className="liens" to="/docteur">
            <TagFacesIcon style={{ margin: 10, fontSize: 30, color: "blue" }} />
            Docteurs
          </NavLink>
          <NavLink className="liens" to="/medecin">
            <Diversity1RoundedIcon
              style={{ margin: 10, fontSize: 30, color: "orange" }}
            />
            Medecins
          </NavLink>
          <NavLink className="liens" to="/sagefemme">
            <GirlRoundedIcon
              style={{ margin: 10, fontSize: 30, color: "blue" }}
            />
            Sages femmes
        ...
        <div className="mainsoeuvres">
          ...
          <NavLink className="liens" to="/entrepreneur">
            <BusinessCenterIcon
              style={{ margin: 10, fontSize: 30, color: "#555" }}
            />
            Entrepreneurs
          </NavLink>
        </div>
        ...
        <div className="mainsoeuvres">
          ...
          <NavLink className="liens" to="/juriste">
            <SchoolIcon style={{ margin: 10, fontSize: 30, color: "#555" }} />
            Avocats
          </NavLink>
        </div>
        ...
        <div className="mainsoeuvres">
          ...
          <NavLink className="liens" to="/animateur">
