...
const SinglepostCommentV = ({commit, objectId}) => {
    ...
    axios
      .put(
        `${domaineURL}/videos/delete/${objectId}/commentaires/${commit._id}`,Headers
      )
      .then((res) => res.data)
     ...
     return (
         <div className='singlepostcommentvideo'>
...
export default SinglepostCommentV;
